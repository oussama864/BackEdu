...
describe('Service Tests', () => {
  describe('Localisation routing resolve service', () => {
    ...
    let resultLocalisation: ILocalisation | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new ILocalisation if id is not provided', () => {
        // GIVEN
        ...
        expect(resultLocalisation).toEqual(new Localisation());
      });
