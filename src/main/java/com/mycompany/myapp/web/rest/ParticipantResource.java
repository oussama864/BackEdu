            ...
            .map(
                existingParticipant -> {
                    if (participant.getCreatedBy() != null) {
                        existingParticipant.setCreatedBy(participant.getCreatedBy());
                    }
                    if (participant.getCreatedDate() != null) {
                        existingParticipant.setCreatedDate(participant.getCreatedDate());
                    }
                    if (participant.getDeleted() != null) {
                        existingParticipant.setDeleted(participant.getDeleted());
                    }
                    if (participant.getDeletedBy() != null) {
                        existingParticipant.setDeletedBy(participant.getDeletedBy());
                    }
                    if (participant.getDeletedDate() != null) {
                        existingParticipant.setDeletedDate(participant.getDeletedDate());
                    }
